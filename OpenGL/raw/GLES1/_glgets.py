...
# JyOpenGL-adjustment:
# Split the code below into two methods, because it exceeds Jython's
# maximal method length otherwise. Note that this restriction is not
# a Jython-issue, but rather a JVM-issue (actually present on Jython's
# issue tracker though: http://bugs.jython.org/issue527524).
